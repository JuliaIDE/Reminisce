...
lt.plugins.reminisce.restore_BANG_ = (function (){var method_table__7236__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var prefer_table__7237__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var method_cache__7238__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var cached_hierarchy__7239__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);var hierarchy__7240__auto__ = cljs.core.get.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",3129050535),cljs.core.get_global_hierarchy.call(null));return (new cljs.core.MultiFn("restore!",new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"default","default",2558708147),hierarchy__7240__auto__,method_table__7236__auto__,prefer_table__7237__auto__,method_cache__7238__auto__,cached_hierarchy__7239__auto__));
})();
...
lt.plugins.reminisce.first_win_QMARK_ = (function first_win_QMARK_(){return cljs.core._EQ_.call(null,lt.objs.app.window_number.call(null),(cljs.core.truth_(lt.objs.platform.atom_shell)?1:0));
});
lt.plugins.reminisce.__BEH__restore_tabs = (function __BEH__restore_tabs(this$){if(lt.plugins.reminisce.first_win_QMARK_.call(null))
{var tabs = lt.objs.cache.fetch.call(null,new cljs.core.Keyword("lt.plugins.reminisce","tabs","lt.plugins.reminisce/tabs",2822751588));if(cljs.core.empty_QMARK_.call(null,tabs))
{return lt.object.raise.call(null,lt.objs.app.app,new cljs.core.Keyword(null,"fresh-start","fresh-start",1380346485));
} else
{var seq__7951 = cljs.core.seq.call(null,lt.objs.cache.fetch.call(null,new cljs.core.Keyword("lt.plugins.reminisce","tabs","lt.plugins.reminisce/tabs",2822751588)));var chunk__7952 = null;var count__7953 = 0;var i__7954 = 0;while(true){
if((i__7954 < count__7953))
{var tab = cljs.core._nth.call(null,chunk__7952,i__7954);lt.objs.tabs.active_BANG_.call(null,lt.plugins.reminisce.restore_BANG_.call(null,tab));
{
var G__7959 = seq__7951;
var G__7960 = chunk__7952;
var G__7961 = count__7953;
var G__7962 = (i__7954 + 1);
seq__7951 = G__7959;
chunk__7952 = G__7960;
count__7953 = G__7961;
i__7954 = G__7962;
...
{var c__7126__auto__ = cljs.core.chunk_first.call(null,seq__7951__$1);{
var G__7963 = cljs.core.chunk_rest.call(null,seq__7951__$1);
var G__7964 = c__7126__auto__;
var G__7965 = cljs.core.count.call(null,c__7126__auto__);
var G__7966 = 0;
seq__7951 = G__7963;
chunk__7952 = G__7964;
count__7953 = G__7965;
...
{var tab = cljs.core.first.call(null,seq__7951__$1);lt.objs.tabs.active_BANG_.call(null,lt.plugins.reminisce.restore_BANG_.call(null,tab));
{
var G__7967 = cljs.core.next.call(null,seq__7951__$1);
var G__7968 = null;
var G__7969 = 0;
var G__7970 = 0;
seq__7951 = G__7967;
...
lt.plugins.reminisce.scroll_pos = (function scroll_pos(ed){return (function (p1__7955_SHARP_){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__7955_SHARP_.left,p1__7955_SHARP_.top], null);
}).call(null,lt.objs.editor.__GT_cm_ed.call(null,ed).getScrollInfo());
});
lt.plugins.reminisce.__BEH__editor_state = (function __BEH__editor_state(editor){var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"info","info",1017141280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor)));return new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1017479852),new cljs.core.Keyword(null,"editor","editor",4001043679),new cljs.core.Keyword(null,"file","file",1017047278),path,new cljs.core.Keyword(null,"content","content",1965434859),(cljs.core.truth_((function (){var or__6378__auto__ = cljs.core.not.call(null,path);if(or__6378__auto__)
...
lt.plugins.reminisce.editor_for_file = (function editor_for_file(file){return cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__7956_SHARP_){return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"info","info",1017141280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,p1__7956_SHARP_))),file);
}),lt.objs.editor.pool.get_all.call(null)));
});
cljs.core._add_method.call(null,lt.plugins.reminisce.restore_BANG_,new cljs.core.Keyword(null,"editor","editor",4001043679),(function (p__7957){var map__7958 = p__7957;var map__7958__$1 = ((cljs.core.seq_QMARK_.call(null,map__7958))?cljs.core.apply.call(null,cljs.core.hash_map,map__7958):map__7958);var cursor = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"cursor","cursor",3959752392));var scroll = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"scroll","scroll",4401191487));var tags = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"tags","tags",1017456523));var info = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"info","info",1017141280));var dirty = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"dirty","dirty",1109497668));var content = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"content","content",1965434859));var file = cljs.core.get.call(null,map__7958__$1,new cljs.core.Keyword(null,"file","file",1017047278));var temp__4092__auto__ = (cljs.core.truth_(file)?(function (){lt.objs.command.exec_BANG_.call(null,new cljs.core.Keyword(null,"open-path","open-path",2513940794),file);
...
{var ed = temp__4092__auto__;if(cljs.core.truth_((function (){var and__6366__auto__ = dirty;if(cljs.core.truth_(and__6366__auto__))
{return content;
} else
...
setTimeout(((function (ed,temp__4092__auto__,map__7958,map__7958__$1,cursor,scroll,tags,info,dirty,content,file){
return (function (){return lt.objs.editor.refresh.call(null,ed);
});})(ed,temp__4092__auto__,map__7958,map__7958__$1,cursor,scroll,tags,info,dirty,content,file))
,500);
return ed;
} else
{return null;
...
lt.plugins.reminisce.workspace_open_QMARK_ = (function workspace_open_QMARK_(){var and__6366__auto__ = cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"active","active",3885920888).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.sidebar.sidebar)),lt.objs.sidebar.workspace.sidebar_workspace);if(and__6366__auto__)
...
lt.plugins.reminisce.open_workspace = (function open_workspace(open){if(cljs.core.truth_((function (){var or__6378__auto__ = (function (){var and__6366__auto__ = open;if(cljs.core.truth_(and__6366__auto__))
{return cljs.core.not.call(null,lt.plugins.reminisce.workspace_open_QMARK_.call(null));
} else
{return and__6366__auto__;
}
})();if(cljs.core.truth_(or__6378__auto__))
{return or__6378__auto__;
} else
{var and__6366__auto__ = cljs.core.not.call(null,open);if(and__6366__auto__)
...
lt.plugins.reminisce.__BEH__restore_workspace = (function __BEH__restore_workspace(){if(lt.plugins.reminisce.first_win_QMARK_.call(null))
...
lt.plugins.reminisce.__BEH__restore_console = (function __BEH__restore_console(){if(lt.plugins.reminisce.first_win_QMARK_.call(null))
